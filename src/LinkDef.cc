...
#include "../include/ReducedTuple.h"
...
"/Users/andres/HEP_Tools/HadronicStopAnalysis/src/",
0
    };
...
class __attribute__((annotate("$clingAutoload$TLorentzVector.h")))  __attribute__((annotate("$clingAutoload$../include/ReducedTuple.h")))  TLorentzVector;
